"""
Renders the 10 sandbox frames with a bowl-shaped projection surface
(flat near the car, curving up to rim_height_m at the outer edge) instead
of a flat ground plane, and saves them to experiments/sample10/bowl_surface/
for visual comparison against the flat baseline.
"""
...
OUT_DIR = os.path.join(EXPERIMENTS_DIR, "sample10", "bowl_surface")
